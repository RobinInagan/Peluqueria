...
if (isset($_POST['grabar']) && $_POST['grabar'] == "si") {
    $cg->editar($_POST['id'], $_POST['desc']);
    exit();
}

$reg = $cg->cargoId($_GET['idcargo']);
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../Cargo/gestionCg.php">Gestión Cargo</a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="posicion">
            <div class="container">
                <div class="card-header ">
                    <br>
                    <h3 class="text-white">ACTUALIZACIÓN DE CARGOS</h3>
                </div>
                <div class=" card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <form name="form" action="editarCg.php" method="POST">
                                <input type="hidden" name="grabar" value="si">
                                <label for="id">Id Cargo</label>
                                <input class="form-control" type="text" name="id" value="<?php echo $_GET['idcargo'] ?>" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="nom_e">Descripción</label>
                            <input type="text" id="desc" name="desc" class="form-control" value="<?php echo $reg[0]['descripcion'] ?>" Required>
                        </div>
                        <br><br><br>
                        <div class="col-md-12 centrar">
                            <input type="button" value="Volver" class="btn btn-dark" title="Volver" onclick="window.location='gestionCg.php'">
